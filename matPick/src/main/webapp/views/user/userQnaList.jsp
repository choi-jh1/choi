...
<body>
  <div class="container">
    ...
    <div class="btn-group">
      <button onclick="location.href='myQnaList.jsp'">내 건의/문의내역</button>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align:center; padding-left:10px;">
              <a style="color: #333;"href="qnaContent.jsp?num=<%=dto1.getNum()%>"><%=dto1.getTitle()%></a>
            </td>
            <td><%=dto1.getNick()%></td>
